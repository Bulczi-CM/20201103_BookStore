...
namespace BookStore
{
    class Program
    {
        ...
        void Run()
        {
            ...
            logConfiguration.WriteTo.File(absolutePath, Serilog.Events.LogEventLevel.Information);
            ...
            {
                logger.Error(e, "niebezpieczna operacja zwróciła wyjątek");
                //throw;
            }*/

            logger.Information("Aplikacja uruchomiona!");
